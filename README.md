...
```bash
curl 'http://localhost:5050/api/v1/tasks?page=1&per_page=20&done=false'
```
...
| `GET` | `/api/v1/tasks` | Получить список с пагинацией и фильтрацией |
...
- сортировка, дедлайны и приоритеты;
